...
def detect_contours_api():
    try:
        ...
        # Séparer les contours extérieurs et intérieurs
        ...
        # Dessiner les contours extérieurs (bleu) et intérieurs (rouge)
        cv2.drawContours(image, external_contours, -1, (255, 0, 0), 2)  # Bleu pour extérieurs
        cv2.drawContours(image, internal_contours, -1, (0, 0, 255), 2)  # Rouge pour intérieurs
